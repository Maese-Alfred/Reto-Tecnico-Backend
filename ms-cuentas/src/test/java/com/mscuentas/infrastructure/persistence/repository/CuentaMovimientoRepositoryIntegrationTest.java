...
class CuentaMovimientoRepositoryIntegrationTest {
    ...
    void findByClienteId_retornaCuentasDelCliente() {
        entityManager.persistAndFlush(buildCuenta("C-001", "CL-A"));
        entityManager.persistAndFlush(buildCuenta("C-002", "CL-A"));
        entityManager.persistAndFlush(buildCuenta("C-003", "CL-B"));
    ...
    void findByCuentaId_retornaMovimientos() {
        entityManager.persistAndFlush(buildCuenta("C-010", "CL-X"));
        entityManager.persistAndFlush(buildMovimiento("M-001", "C-010"));
        entityManager.persistAndFlush(buildMovimiento("M-002", "C-010"));
    ...
    void findByCuentaIdAndFechaBetween_filtraPorFechas() {
        entityManager.persistAndFlush(buildCuenta("C-020", "CL-Y"));
        ...
        entityManager.persistAndFlush(mov1);
        entityManager.persistAndFlush(mov2);
        entityManager.persistAndFlush(mov3);
